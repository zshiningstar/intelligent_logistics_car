...
namespace lslidar_rawdata {
    ...
    void RawData::loadConfigFile(ros::NodeHandle node, ros::NodeHandle private_nh) {
        ...
        private_nh.param("scan_start_angle", scan_start_angle_, float(0));
        private_nh.param("scan_end_angle", scan_end_angle_, float(36000));
 ...
 */
    void
    RawData::unpack(const lslidar_c16_msgs::LslidarC16Packet &pkt, pcl::PointCloud<pcl::PointXYZI>::Ptr pointcloud) {
